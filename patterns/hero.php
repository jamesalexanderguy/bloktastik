...
/**
 * Title: Title Banner
 * Slug: bloktastik/title-banner
 * Categories: lowercolumbia, banner, hero
 * Description: Page banner with featured image and description
...
<div class="wp-block-group"><!-- wp:post-title {"style":{"elements":{"link":{"color":{"text":"var:preset|color|coral"}}}},"textColor":"coral","fontSize":"4xl"} /-->

<!-- wp:heading {"level":3,"fontSize":"3xl"} -->
<h3 class="wp-block-heading has-3-xl-font-size">Describe the contents of this page...</h3>
<!-- /wp:heading --></div>
<!-- /wp:group -->
