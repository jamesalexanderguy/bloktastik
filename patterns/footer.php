...
<div class="wp-block-group alignfull"><!-- wp:cover {"useFeaturedImage":true,"dimRatio":0,"customOverlayColor":"#FFF","isUserOverlayColor":true,"isDark":false,"className":"footer-cover","layout":{"type":"constrained"}} -->
<div class="wp-block-cover is-light footer-cover"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim" style="background-color:#FFF"></span><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","fontSize":"large"} -->
...
<div class="wp-block-group alignfull arrow-up has-logo-blue-color has-text-color has-link-color"></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-button is-style-green-red w-[10rem] mb-5 h-3/5 mx-2"><a class="wp-block-button__link wp-element-button" href="https://allsetpack.ca/first-nations-readiness/">First Nations Readiness</a></div>
<!-- /wp:button -->

<!-- wp:button {"className":"is-style-green-red w-[10rem] mb-5 h-3/5 mx-2"} -->
<div class="wp-block-button is-style-green-red w-[10rem] mb-5 h-3/5 mx-2"><a class="wp-block-button__link wp-element-button" href="https://allsetpack.ca/municipal-readiness/">Municipal Readiness</a></div>
<!-- /wp:button --></div>
<!-- /wp:group -->
...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)"><!-- wp:paragraph {"className":"text-lg text-white text-center"} -->
<p class="text-lg text-white text-center">We are grateful to live, work, and build community within the forests, waters, and mountains of the West Kootenay region, on the traditional territory of the Sinixt, Ktunaxa, and Syilx peoples. We are committed to learning, listening, and taking meaningful action toward reconciliation.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:navigation {"ref":879,"overlayMenu":"never","className":"mt-12 mb-10 flex justify-center space-x-4"} /-->

<!-- wp:group {"align":"full","className":"mx-auto p-10 md:px-12 xl:px-6 mt-6 bg-footer-base","layout":{"type":"default"}} -->
<div class="wp-block-group alignfull mx-auto p-10 md:px-12 xl:px-6 mt-6 bg-footer-base"><!-- wp:group {"align":"full","className":"text-white text-center text-xs","layout":{"type":"default"}} -->
<div class="wp-block-group alignfull text-white text-center text-xs"><!-- wp:paragraph -->
