...
<div class="wp-block-column" style="flex-basis:75%"><!-- wp:post-title {"style":{"elements":{"link":{"color":{"text":"var:preset|color|coral"}}}},"textColor":"coral","fontSize":"4xl"} /-->

<!-- wp:heading {"level":3,"fontSize":"3xl"} -->
<h3 class="wp-block-heading has-3-xl-font-size">We are a Community Health Centre (CHC) focused on team-based primary care, health promotion, and addressing factors that affect well being.</h3>
<!-- /wp:heading --></div>
<!-- /wp:column -->
