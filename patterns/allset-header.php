...
<header id="header" class="banner z-30 sticky top-0 transition duration-300 ease-in-out">
	...
	<nav id="shortHead" class="bg-white w-full z-10 relative" aria-label="Primary Navigation">
...
<!-- wp:html -->
					...
					<div class="mt-8 lg:mt-0">
						<a href="#contact" class="relative flex h-9 w-full items-center justify-center px-4 before:absolute before:inset-0 before:rounded-md before:bg-primary before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 sm:w-max">
							<span class="relative text-sm font-semibold text-white">Contact</span>
						</a>
					</div>
				</div>
			</div>
