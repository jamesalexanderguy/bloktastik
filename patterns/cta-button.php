...
<h3 class="wp-block-heading has-text-align-center has-base-color has-text-color has-xl-font-size"><strong>Your CTA heading</strong></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"base","fontSize":"lg"} -->
<p class="has-text-align-center has-base-color has-text-color has-lg-font-size">Add your supporting message or instructions here.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-default"><a class="wp-block-button__link wp-element-button" href="/"><strong>ACTION LABEL</strong></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
